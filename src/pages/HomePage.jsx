        ...
        <div className="services pt-32" id="services">
          ...
          <div className="services-box pt-12 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              ...
              <p className="text-white text-base/loose">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia aliquid id voluptate, obcaecati iste quas.</p>
            </div>
            <div className="box bg-sky-400 rounded-lg shadow p-4">
            ...
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              ...
              <h3 className="text-xl font-bold text-white mt-6 mb-2">Service Name 4</h3>
              <p className="text-white text-base/loose">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia aliquid id voluptate, obcaecati iste quas.</p>
            </div>
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              <i className="ri-number-5 text-3xl text-white"></i>
              <h3 className="text-xl font-bold text-white mt-6 mb-2">Service Name 5</h3>
              <p className="text-white text-base/loose">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia aliquid id voluptate, obcaecati iste quas.</p>
            </div>
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              <i className="ri-number-6 text-3xl text-white"></i>
              <h3 className="text-xl font-bold text-white mt-6 mb-2">Service Name 6</h3>
              <p className="text-white text-base/loose">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia aliquid id voluptate, obcaecati iste quas.</p>
            </div>
          </div>
        </div>
        ...
        <div className="proyek pt-32" id="proyek">
          ...
          <div className="proyek-box pt-12 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box p-2 bg-white shadow">
              ...
              <p className=" text-base/loose">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos porro, fugit quaerat odio mollitia autem?</p>
            </div>
            <div className="box p-2 bg-white shadow">
